...
currentelem = 2
potentialelem = 9-2 = 7
is potentialelem in the hash map? no -> add 2 to hashtable


currentelem = 7
potentialelem = 9-7 = 2
is potentialelem in the hash map? yes -> return [2, 7] or [0, 1]
...
is potentialelem in the hash map? no -> add 7 to hashtable
hash_table = {
              2: 0
              7: 1
                   }
...
is potentialelem in the hash map? yes -> return [hashtable[2], currentelem_idx]
...
it is not necessary to store each number's index as value in the hash map.
